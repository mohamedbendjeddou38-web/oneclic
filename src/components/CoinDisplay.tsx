...
const CoinDisplay: React.FC = () => {
    ...
    return (
        <div className="absolute inset-0 flex flex-col items-center justify-start pt-8 pb-2">
            {/* Dynamic Background */}
            {/* Background moved to page.tsx */}

            <h1 className="font-pirate text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#fde047] to-[#ca8a04] drop-shadow-lg mb-4 tracking-wider animate-pulse-gold pointer-events-none text-center leading-tight">
                ClickCoins
            </h1>

            {/* Container to center the coin in the remaining space */}
            <div className="flex-grow flex flex-col items-center justify-center w-full -mt-12">
                {/* Interactive Coin */}
                <div
                ...
                >
                    <div className="absolute inset-0 -m-8 opacity-40">
                        <div className="w-full h-full border-4 border-dashed border-white/30 rounded-full animate-[spin_60s_linear_infinite]"></div>
                    </div>

                    <div className={`w-72 h-72 rounded-full relative z-10 flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.6)] ${activeSkin.image ? '' : `border-4 ${activeSkin.border} bg-gradient-to-br ${activeSkin.colors}`}`}>
                        {activeSkin.image ? (
                            <img
                ...
                <div className="mt-12 bg-black/40 backdrop-blur-md px-6 py-3 rounded-full border border-white/10 flex flex-col items-center gap-1 shadow-lg pointer-events-none">
                    <div className="text-[10px] uppercase text-blue-200 tracking-widest font-bold">Puissance de Clic</div>
